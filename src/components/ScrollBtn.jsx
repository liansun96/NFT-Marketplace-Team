...
const ScrollBtn = () => {
 ...
 duration-1000 ease-in-out rounded-md hover:bg-gradient-to-l from-[#cc42e4] to-[#6345ed]  bg-gradient-to-r  fixed bottom-7 md:bottom-24 lg:bottom-7 right-7 w-[50px] h-[50px] z-40 `}
      >
