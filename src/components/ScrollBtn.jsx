...
const ScrollBtn = () => {
 ...
 duration-1000 ease-in-out rounded-md hover:bg-gradient-to-l from-[#cc42e4] to-[#6345ed]  bg-gradient-to-r from-[#bc3cd3] to-[#6345ed] fixed bottom-7 md:bottom-24 right-7 w-[50px] h-[50px] z-40 `}
      >
