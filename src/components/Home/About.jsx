  ...
  return (
    <div className="bg-[#070b24] flex items-center">
      <div className="w-[90%] 3xl:w-[70%] 4xl:w-[55%] mx-auto">
        <div className="flex flex-col flex-wrap  md:flex-row justify-between gap-6 md:gap-5 lg:gap-2 mb-6">
          <div className="relative duration-700 hover:-translate-y-5 md:w-[320px] lg:w-[260px] 2xl:w-[300px] h-[180px] bg-primary rounded-xl p-7 space-y-5">
